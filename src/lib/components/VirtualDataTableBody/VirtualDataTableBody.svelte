<script lang="ts">
	...
	// local state
	let content: HTMLTableSectionElement;
	let height_map: number[] = [];
	let rows: any[] | HTMLCollectionOf<Element>;
...
>
	<DataTableBody bind:tbody={content} style="padding-top: {top}px; padding-bottom: {bottom}px;">
